...
func (o *FizzbuzzParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.FizzbuzzParams
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("fizzbuzzParams", "body", ""))
			} else {
				res = append(res, errors.NewParseError("fizzbuzzParams", "body", "", err))
			}
		} else {
